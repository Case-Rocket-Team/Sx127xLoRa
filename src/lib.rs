    ...
    CS: OutputPin,
{
    ...
    pub fn configure<F>(
        &mut self,
        modifier: F,
    ) -> Result<(), Error<E, CS::Error>>
    where
        F: FnOnce(&mut Self) -> Result<(), Error<E, CS::Error>>,
    {
    ...
    pub fn set_dio0_tx_done(&mut self) -> Result<(), Error<E, CS::Error>> {
    ...
    pub fn read_packet(&mut self) -> Result<[u8; 255], Error<E, CS::Error>> {
    ...
    /// ready to be read.
    pub fn get_ready_packet_size(&mut self) -> Result<u8, Error<E, CS::Error>> {
        self.read_register(Register::RegRxNbBytes.addr())
    }

    /// Returns true if the radio is currently transmitting a packet.
    pub fn transmitting(&mut self) -> Result<bool, Error<E, CS::Error>> {
    ...
    pub fn clear_irq(&mut self) -> Result<(), Error<E, CS::Error>> {
    ...
    pub fn set_ocp(&mut self, ma: u8) -> Result<(), Error<E, CS::Error>> {
    ...
    pub fn set_mode(&mut self, mode: RadioMode) -> Result<(), Error<E, CS::Error>> {
        if self.explicit_header {
            self.set_explicit_header_mode()?;
        } else {
            self.set_implicit_header_mode()?;
    ...
    pub fn set_frequency(&mut self, freq: i64) -> Result<(), Error<E, CS::Error>> {
        self.frequency = freq;
    ...
    fn set_explicit_header_mode(&mut self) -> Result<(), Error<E, CS::Error>> {
    ...
    fn set_implicit_header_mode(&mut self) -> Result<(), Error<E, CS::Error>> {
        let reg_modem_config_1 = self.read_register(Register::RegModemConfig1.addr())?;
    ...
    pub fn set_crc(&mut self, value: bool) -> Result<(), Error<E, CS::Error>> {
        let modem_config_2 = self.read_register(Register::RegModemConfig2.addr())?;
        if value {
    ...
    pub fn set_invert_iq(&mut self, value: bool) -> Result<(), Error<E, CS::Error>> {
        if value {
    ...
    pub fn get_spreading_factor(&mut self) -> Result<u8, Error<E, CS::Error>> {
        Ok(self.read_register(Register::RegModemConfig2.addr())? >> 4)
    }

    /// Returns the signal bandwidth of the radio.
    pub fn get_signal_bandwidth(&mut self) -> Result<i64, Error<E, CS::Error>> {
    ...
    pub fn get_packet_rssi(&mut self) -> Result<i32, Error<E, CS::Error>> {
    ...
    pub fn get_packet_snr(&mut self) -> Result<f64, Error<E, CS::Error>> {
        Ok(f64::from(
    ...
    pub fn get_packet_frequency_error(&mut self) -> Result<i64, Error<E, CS::Error>> {
    ...
    fn set_ldo_flag(&mut self) -> Result<(), Error<E, CS::Error>> {
    ...
    fn read_register(&mut self, reg: u8) -> Result<u8, Error<E, CS::Error>> {
    ...
    pub fn put_in_fsk_mode(&mut self) -> Result<(), Error<E, CS::Error>> {
        // Put in FSK mode
